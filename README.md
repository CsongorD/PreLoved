...
<br>
  <p align="center">
    ...
    <br>
    <br>
    <a href="https://github.com/CsongorD/PreLoved"><strong>Explore the docs :arrow_right:	</strong></a>
    <br />
...
```sh
git clone git@github.com:CsongorD/PreLoved.git
```
...
:six: If the backend started successfully, you can view the site on http://localhost:8080/
...
If you want to run the application dockerized: <br>
 <br>
:one: Open a terminal, move into the `PreLoved` folder <br>
...
[forks-shield]: https://img.shields.io/github/forks/CsongorD/PreLoved?style=for-the-badge
[forks-url]: https://github.com/CsongorD/PreLoved/forks
[stars-shield]: https://img.shields.io/github/stars/CsongorD/PreLoved?style=for-the-badge
[stars-url]: https://github.com/CsongorD/PreLoved/stargazers
[issues-shield]: https://img.shields.io/github/issues/CsongorD/PreLoved?style=for-the-badge
[issues-url]: https://github.com/CsongorD/PreLoved/issues
